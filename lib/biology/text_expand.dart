        ...
        return Text.rich(
          TextSpan(
              ...
              children: [
                TextSpan(
                    text: '收起',
                    style: TextStyle(color: widget.textColor==null?Colors.white: widget.textColor),
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: GestureDetector(
                ...
                child: Container(
                  width: 100,
                  color: widget.textColor==null?Color(0xFF7ACFD6):Colors.white,
                  child: Text(
                    '展开',
                    style: TextStyle(color: widget.textColor==null?Colors.white:widget.textColor, fontSize: 14),
                  ),
                ),
              ),
            ),
